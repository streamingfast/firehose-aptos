...
require (
	...
	github.com/streamingfast/merger v0.0.3-0.20220906203534-fcb32d7ccdc0
...
require (
	...
	github.com/streamingfast/firehose-aptos/types v0.0.0-20220908194130-bfe2d9d84520 // indirect
